class Bubblechart {
    constructor(width,height,padding,labelsize,viewport,jumplength,xlabel,ylabel,datakeys,timeformat,iconwidth,iconheight,iconcolor,iconhighlight,url,iso,scales,colors,circleopacity,highlightfactor,minradius,maxradius,div_hook,line_stroke,shape_rendering,font_size,axis_label_size) {
        this.width = width;
        this.height = height;
    ...
    create() {
        ...
        d3.json(_this.url, function(data){
            ...
            let radius_extent = [min_radius, max_radius]
            let xScale;
            let yScale;
            let yAxisScale;
            let circleScale;
            ...
            function drawData(y_accessor){
                ...
                function drawCircles(index){
                    ...
                    circles = _this.svg.append("circle")
                             ...
                             .attr("cy", function(d) {
                                return _this.height - yScale(d[index].y[y_accessor][0]);
                             })
                             .attr("r", function(d){
                ...
                _this.svg.selectAll("circle")
                    .on("mouseover", function(){
                        ...
                        .attr('r', d3.select(this).attr('r') * _this.highlightfactor)
